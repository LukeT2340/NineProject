...
const ArticleFive = () => {
    return (
        ...
        <div className="flex flex-col md:flex-row justify-center items-center md:space-x-10 md:space-y-0 space-y-10">
            <img className="w-full" src="./src/assets/images/article/ArticleImage5a.png" alt="Man in blue shirt wearing a shiny silver necklace with a K symbol on it" />
            <img className="w-full" src="./src/assets/images/article/ArticleImage5b.png" alt="Girl with frizzy hair" />
            <img className="w-full" src="./src/assets/images/article/ArticleImage5c.png" alt="Man looking at camera with arms crossed" />
        </div>
        </article>
    )
}
